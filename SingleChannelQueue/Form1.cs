...
namespace Simulation
{
    public partial class Form1 : Form
    {
        ...
        private void RunSimulation(object sender, EventArgs e)
        {
            ...
            List<float> randomForIT = RandomGenerator.GenerateRandomNumbers(customerCount);
            List<float> randomForST = RandomGenerator.GenerateRandomNumbers(customerCount);
            ...
            {
                int interarrivalTime = RandomGenerator.LookupValueByRandomNumber(tbaTable, "First Column", randomForIT[i]);
                int serviceTime = RandomGenerator.LookupValueByRandomNumber(stTable, "First Column", randomForST[i]);
